...
import './PropertySection.css'; // Import the CSS file for styling
        ...
        <div className="property-section-container">
            ...
            <div className="property-info">
                <div className="property-text">
                    ...
                    <button style={{ marginLeft: "-65%", paddingTop: "3%", paddingBottom: "3%", paddingLeft: "3%", paddingRight: "3%", fontWeight: "400",backgroundColor:"white",color:"black" }}>
                        DOWNLOAD BROCHURE
                    </button>
                ...
                <div className="property-image" style={{ marginTop: "-8%", position: 'relative' }}>
                    <img src={`${process.env.PUBLIC_URL}/property-image.jpg`} alt="Property" />
